...
<head>
    ...
    <title>Sign Up Form by SGL</title>
    <!-- Font Icon -->
...
<body class="bcolor"
    src="https://www.klipfolio.com/sites/all/themes/klipfolio_theme/img/illustrations/illustration-agency.svg?v2">
    <!-- <img alt=""> -->
    <div class="main">
                ...
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input autocomplete="off" type="email" class="form-input" name="email" id="email"
                                placeholder="Your Email" />
                        </div>
                        <div class="form-group">
                            <input autocomplete="off" type="text" class="form-input" name="password" id="password"
